...
Event.create!(name: "Pinkpop", description: "Pinkpop is een jaarlijks,
...
Event.create!(name: "Zwarte Cross", description: "The Zwarte Cross Festival
...
Event.create!(name: "Rock am Ring", description: "The Rock am Ring (German: Rock at the Ring)
